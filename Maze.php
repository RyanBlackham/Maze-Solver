		...
		class MazeSolver{
			...
			public function getPath(){				
				...
				do {
					...
					//making a $finished variable was probably unecessary, however when i had the if state as part of the while it didn't work
			...
			public function findDirection(){
				...
				if ($this->pathsCount > 1){
					...
					array_push($this->intersectionX, $this->currentX);
					array_push($this->intersectionY, $this->currentY);
					}
			...
			$solvedMaze = new MazeSolver("maze.png");
